...
public class CameraView : View, ICameraView
{
	...
	internal void OnFrameReceived(byte[] pixels, int width, int height)
	{
        // Handle frame here (e.g., for light detection, previews, etc.)
        //System.Diagnostics.Debug.WriteLine("Frame received: " + pixels?.Length);
	}
